    ...
    export default {
        data() {
            return {
                ...
                defaultCustomerInformation: { username: null, name: null, address: null, contact_number: null, password: null, password_confirmation: null},
                editedCustomerInformation: { username: null, name: null, address: null, contact_number: null, password: null, password_confirmation: null},
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'New Customers' : 'Edit Customers'
            },
        },
        methods: {
            retrieveCustomers() {
